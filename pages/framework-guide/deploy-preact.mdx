...
After deploying, your new preact project will automatically be assigned a `.spheron.app` suffixed domain. You can then add a [Custom Domain](https://docs.spheron.network/domain-and-https/centralized-domain/attach-domain) of your choice.
