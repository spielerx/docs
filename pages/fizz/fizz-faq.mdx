...
No, it's not mandatory. The Fizz Node installation script handles Docker installation for you. However, if you already have Docker installed, please ensure that it is updated to the latest version.
...
Spheron aims to maximize your earnings by creating a resource pool of idle resources. However, your earnings depend on various factors, including demand. In addition to direct utilization rewards, Spheron offers IDLE rewards in Spheron points. The network requires a token to operate, and any related information will be communicated publicly.
