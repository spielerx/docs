...
4. Make the script executable by running the following command:
   ...
   ```
   Replace `<location of fizzup script>` with the actual path to the directory containing the script.
...
12. Once your node is confirmed as active, you will be automatically directed to your Fizz dashboard.

## Accessing Your Dashboard

After your node has been successfully validated and marked as active, you'll be redirected to the main Fizz node dashboard. This dashboard is your control center for managing your node and tracking your earnings. Here's what you can expect:
