...
<Callout type="info">
This step is only necessary if you were unable to get ETH from the Spheron faucet. If you successfully obtained ETH from the Spheron faucet, you can skip this step.
</Callout>
...
2. Click on it or press the Command (⌘) key and the Space bar at the same time.
