...
- If the node fails to respond, it fails the liveness check for that hour.
...
In addition to the liveness rewards, Fizz node operators can earn directly from users who lease their compute resources. This provides an additional revenue stream for node operators.
...
- **Foundation Fee**: 5% of the earning goes to the Spheron Foundation
...
By offering competitive pricing and maintaining good resource availability, you can maximize your direct earnings from user leases in addition to the liveness rewards.
