...
We support almost all Nvidia GPUs and are continuously adding support for new GPUs, including AMD GPUs. This table is useful if you want to become a fizz node and lend your GPU. Here is the definition of the columns:
...
- **Tier:** This helps fizzer understand which resource tier and associated multiplier they are eligible for. This is important for receiving points as part of the fizz network.
...
We support almost all CPU types and are continuously adding support for new CPUs. This table is useful if you want to become a fizz node and lend your CPU. Here is the definition of the columns:
...
- If a Fizz node's liveness falls below 50% in an ERA, your will not accrue any points for that ERA.
...
- **Gateway Fee**: 5% of the earning goes to the gateway
