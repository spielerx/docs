...
### Step 3: Get Some test token from the Faucet and ETH from the Faucet

1. Visit the [Spheron Faucet](https://faucet.spheron.network/). 

![Spheron Faucet](assets/spheron-faucet.png)

2. First, get some ETH gas token on the Spheron chain:
...
3. Next, get some USDT token for testing deployment:
...
5. Check if you got the test ETH and USDT tokens on your wallet:
```
sphnctl wallet balance --token USDT
```
This will show both USDT and ETH balance in your wallet.
...
<Callout type="info">
**Note:** This step is only necessary if you were unable to get ETH from the Spheron faucet in Step 3. If you successfully obtained ETH from the Spheron faucet, you can skip this step.
</Callout>
