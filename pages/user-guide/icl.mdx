...
| env        | No                 | Sets environment variables for the running container. Refer to the [services.env](/user-guide/icl#3-services-configuration) section for more details.                                     |
| expose     | No                 | Determines which entities are permitted to connect to the services. See the [services.expose](/user-guide/icl#port-exposure-in-servicesexpose) section for additional information.               |
