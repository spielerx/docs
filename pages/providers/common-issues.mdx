...
2. In the `provider-config.json`, ensure you update the GPU section properly. To fill this data, please refer to the [GPU support](/user-guide/supports#gpu-support--tiering) section to get the GPU name.
