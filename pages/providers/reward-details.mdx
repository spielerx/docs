...
Providers can earn rewards based on the GPU resources they contribute to the network. Different GPU models are categorized into tiers, each with its own multiplier. The higher the tier and multiplier, the greater the rewards for that GPU. Below is a table showing all supported GPU models, their tiers, and corresponding multipliers:

| **GPU Model**                | **GPU Short Name** | **Tier**     | **Multiplier** | **Base Reward (SP)** |
|------------------------------|--------------------|--------------|----------------|----------------------|
...
| **CPU Type**                | **CPU Short Name** | **Tier**     | **Multiplier** | **Base Reward (SP)** |
|-----------------------------|--------------------|--------------|----------------|----------------------|
